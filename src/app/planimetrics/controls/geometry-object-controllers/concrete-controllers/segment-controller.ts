...
export class SegmentController extends GeometryObjectController {
    ...
    private generalDestructStrategy(): {x1: number, y1: number, x2: number, y2: number} {
    ...
    private generalReconstructStrategy(obj: {x1: number, y1: number, x2: number, y2: number}): Segment {
